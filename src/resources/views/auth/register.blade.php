                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                            ...
                            <div class="col-md-6">
                                <select id="role" class="form-control" name="institution_id">
                                    ...
                                    @foreach($institutions as $id => $name)
                                        <option value="{{$id}}"
                                                @if(old('institution_id') == $id) selected="selected" @endif>{{$name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('cnp') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">CNP</label>

                            <div class="col-md-6">
                                <input id="cnp" class="form-control" name="cnp" value="{{ old('cnp') }}">
                                @if ($errors->has('cnp'))
                                    <span class="help-block">
